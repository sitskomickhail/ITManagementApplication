...
{
    public class DeveloperProjectsListViewModel : BaseViewModel, IControlViewModel
    {
        public IEnumerable<PageDefinition> PageDefinitions => new List<PageDefinition> { PageDefinition.Developer };
        ...
        public BaseActionHandler<GetDeveloperProjectsRequestModel, SearchProjectResponseModel> GetDeveloperProjectsActionHandler { get; set; }

        public DeveloperProjectsListViewModel()
        {
            ...
            GetDeveloperProjectsActionHandler = new GetDeveloperProjectsActionHandler();
        ...
        private void SearchByParameterCommandExecute(object obj)
        {
            try
            {
                var actionResult = GetDeveloperProjectsActionHandler.ExecuteHandler(new GetDeveloperProjectsRequestModel()
                {
                    SearchParameter = SearchParameter,
                    DeveloperId = UserManager.GetCurrentConnectedUser().Id
                });
